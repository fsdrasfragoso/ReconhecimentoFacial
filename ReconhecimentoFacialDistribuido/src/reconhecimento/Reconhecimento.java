...
/**
 *
 * @author Esdras Fragoso da Silva Neto 
 */
public class Reconhecimento {
    ...
    public static void main (String args[]) throws FrameGrabber.Exception{
        ...
        //reconhecedor.load("src\\recursos\\classsificadorEigenFaces.yml");
       ...
       CanvasFrame cFrame = new CanvasFrame("Reconhecimento", CanvasFrame.getDefaultGamma() / camera.getGamma());
        ...
        String[] pessoas = {"","Esdras","Joice","Ana K","Diego Fernando","Vitor","D. V","Renan"};
